...
namespace Ecommerce.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DepartamentsId = new SelectList(CombosHelper.GetCities(), "DepartamentsId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CityId,DepartamentsId,Name")] City city)
        {
