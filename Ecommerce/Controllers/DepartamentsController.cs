        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            catch (System.Exception ex)
            {
                if(ex.InnerException != null && ex.InnerException.InnerException != null && ex.InnerException.InnerException.Message.Contains("REFERENCE")) {
                    ModelState.AddModelError(string.Empty, "Não é possível remover o departamento pois existe cidades relacionadas a ele. Remova as cidades, então volte a tentar!!");
